...
var wasmBinaryFile;
  wasmBinaryFile = 'output.node.wasm';
...
// end include: preamble.js
  ...
  var ___stack_high = 69552;

  var ___stack_low = 4016;

  var ___stack_pointer = new WebAssembly.Global({'value': 'i32', 'mutable': true}, 69552);
  ...
  if (!asyncifyStubs['add'] || asyncifyStubs['add'].stub) abort("external symbol 'add' is missing. perhaps a side module was not linked in? if this function was expected to arrive from a system library, try to build the MAIN_MODULE with EMCC_FORCE_STDLIBS=1 in the environment");
  return asyncifyStubs['add'](...args);
  }
  _add.stub = true;
  asyncifyStubs['add'] = undefined;
...
var _async_extern_add = Module['_async_extern_add'] = createExportWrapper('async_extern_add', 0);
...
function stackCheckInit() {
  ...
  // here.
  _emscripten_stack_set_limits(69552 , 4016);
