...
// end include: preamble.js
  ...
  if (!wasmImports['add'] || wasmImports['add'].stub) abort("external symbol 'add' is missing. perhaps a side module was not linked in? if this function was expected to arrive from a system library, try to build the MAIN_MODULE with EMCC_FORCE_STDLIBS=1 in the environment");
  return wasmImports['add'](...args);
  }
  _add.stub = true;
...
var _wasm_sleep = Module['_wasm_sleep'] = createExportWrapper('wasm_sleep', 1);
